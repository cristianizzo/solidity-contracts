...
contract Genesis is ERC721ACommon, ERC2981, Ownable, Pausable {
  ...
  string public tokenBaseURI = "https://tester/";

  constructor(address _royaltyReceiver) ERC721A("For the Testers", "TESTING") {
